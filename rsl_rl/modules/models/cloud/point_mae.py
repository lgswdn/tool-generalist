...
from rsl_rl.modules.models.common import merge_shapes
from rsl_rl.modules.util.config import recursive_replace_map, ConfigBase
from rsl_rl.modules.util.torch_util import dcn
...
class PointMAEEncoder(nn.Module):
    @dataclass
    class Config(ConfigBase):
        layer: PointMAELayer.Config = field(default_factory=PointMAELayer.Config)

"""GG 15k continuation from the fingertip-only paper-head DGN parent."""
...
PARENT_EXPERIMENT = "ce_prl_unicorn_d1_full_paper_head_dgn_10k"
...
EXP_CFG.rl.init_checkpoint = completed_parent_checkpoint(
    PARENT_EXPERIMENT,
    contact_name="contact_gen_prl_paper_head_500k",

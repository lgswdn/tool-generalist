"""Non-penetrating 2 mm labels with label-compatible augmentation ablation."""
...
# Shared rigid transforms preserve pairwise distances and therefore preserve
# the 2 mm SDF labels. Remove the large random scale and reduce independent
# point jitter from 10 mm to the legacy 1 mm value.

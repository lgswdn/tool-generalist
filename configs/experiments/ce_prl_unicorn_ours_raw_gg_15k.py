"""Parallel-only raw-contact GG 15k transfer from matching DGN 10k."""
...
PARENT_EXPERIMENT = "ce_prl_unicorn_ours_raw_dgn_10k"


EXP_CFG = parallel_depth1_full_attention_unicorn_rl_cfg(
    "ce_prl_unicorn_ours_raw_gg_15k",
    raw_contact=True,
)
EXP_CFG.pretrain.retrain = False
EXP_CFG.pretrain_reuse = "ce_prl_unicorn_ours_raw_dgn_10k.py"

...
EXP_CFG.rl.env.visualize_tool_pointcloud = False
EXP_CFG.rl.observation.object_cloud_source = "preprocessed"
EXP_CFG.rl.observation.object_cloud_preprocessed_dir = (
    "/mnt/project/world_model/tool_generalist/assets/DGN/"
    "first_hit_fps_pointclouds/npy"
)
EXP_CFG.rl.launch.logger = "tensorboard"
EXP_CFG.rl.launch.wandb_project = None
EXP_CFG.rl.launch.wandb_upload_files = False

"""Generated-gripper 50/50 goals initialized from the DPOC-big policy."""
...
BIG_POLICY_CHECKPOINT = (
    "/mnt/project/world_model/tool_generalist/artifacts/RL/"
    "panda_general_dpoc_big/no-contact/TCE/panda_general_dpoc_big/"
    "20260712T021828Z/model_best.pt"
)
...
EXP_CFG = generated_gripper_diff_post_rl_cfg("panda_general_dpoc_from_big")
...
EXP_CFG.rl.init_checkpoint = BIG_POLICY_CHECKPOINT

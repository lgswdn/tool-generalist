"""GG15k continuation of the parallel-only frozen-oracle DGN parent."""

from configs.experiments.ce_prl_oracle_pointcloud_pointnet_ggbest_frozen_dgn_5k import (
    GG_BEST_CHECKPOINT,
)
...
PARENT = "ce_prl_oracle_pointcloud_pointnet_ggbest_frozen_dgn_5k"

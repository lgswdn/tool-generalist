"""Generated-gripper object-centered diff-post RL with stable-pose target goals only."""

from configs.panda_experiment_common import generated_gripper_diff_post_rl_cfg


EXP_CFG = generated_gripper_diff_post_rl_cfg("panda_general_diff_post_oc_stable")

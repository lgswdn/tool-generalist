"""Rank-10 bottleneck GG 15k transfer from its completed full-YES parent."""
...
PARENT_EXPERIMENT = "panda_general_unicorn_ours_encoder_bottleneck_rank10_full_yes_5k"
...
EXP_CFG = generated_gripper_unicorn_rl_cfg(
    "panda_general_unicorn_ours_encoder_bottleneck_rank10_gg_from_full_yes_5k",
    ours_tce=True,
)

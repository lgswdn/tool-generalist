"""Native direct-128 PointNet diffusion pretraining and original-setting DGN."""

from configs.panda_comparison_common import configure_full_yes_comparison
from configs.panda_experiment_common import (
    generated_gripper_native_pointnet_diffusion_rl_cfg,
)


NAME = "panda_general_native_pointnet_diff_original400_dgn_5k"

EXP_CFG = generated_gripper_native_pointnet_diffusion_rl_cfg(NAME)

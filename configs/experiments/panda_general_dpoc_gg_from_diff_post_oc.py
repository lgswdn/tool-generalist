"""Generated-gripper DPOC RL initialized from diff-post-OC policy weights."""
...
EXP_CFG = generated_gripper_diff_post_rl_cfg("panda_general_dpoc_gg_from_diff_post_oc")
...
EXP_CFG.rl.init_checkpoint = DIFF_POST_OC_INIT_CHECKPOINT

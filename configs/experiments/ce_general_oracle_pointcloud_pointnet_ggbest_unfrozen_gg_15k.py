"""GG15k continuation of the combined-gripper unfrozen-oracle DGN parent."""

from configs.experiments.ce_general_oracle_pointcloud_pointnet_ggbest_unfrozen_dgn_5k import (
    GG_BEST_CHECKPOINT,
)
...
from configs.panda_experiment_common import (
    ...
    general_unfrozen_gg_oracle_pointcloud_pointnet_rl_cfg,
)


PARENT = "ce_general_oracle_pointcloud_pointnet_ggbest_unfrozen_dgn_5k"

EXP_CFG = general_unfrozen_gg_oracle_pointcloud_pointnet_rl_cfg(

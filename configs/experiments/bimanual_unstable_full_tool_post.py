"""Bimanual RL using the full-tool postcontact pretrained encoder."""
...
EXP_CFG.name = "bimanual_unstable_full_tool_post"
EXP_CFG.general.name = "bimanual_unstable_full_tool_post"
...
EXP_CFG.pretrain_reuse = "multitools_full_tool_post.py"
...
EXP_CFG.rl.name = "bimanual_unstable_full_tool_post"
EXP_CFG.rl.launch.run_name = "bimanual_unstable_full_tool_post"

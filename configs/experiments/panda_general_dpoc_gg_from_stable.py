"""Generated-gripper GG RL initialized from stable-only policy weights."""
...
EXP_CFG = generated_gripper_diff_post_rl_cfg("panda_general_dpoc_gg_from_stable")
...
EXP_CFG.rl.init_checkpoint = STABLE_INIT_CHECKPOINT

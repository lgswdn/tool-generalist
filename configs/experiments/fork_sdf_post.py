...
EXP_CFG = ExpCfg(name="fork_sdf_post")
EXP_CFG.general.name = "fork_sdf_post"
EXP_CFG.general.tools_selected_json = "/mnt/project/world_model/tool_generalist/eef/tools_fork.json"
EXP_CFG.model.name = "tce_sdf_post"
...
EXP_CFG.pretrain.wandb_run_name = "sdf_post"

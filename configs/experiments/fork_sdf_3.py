...
EXP_CFG.model.name = "tce_sdf_only_256"
...
EXP_CFG.model.encoder_channel = 128
EXP_CFG.model.output_dim = 128
EXP_CFG.model.policy_fusion.query_dim = 128

EXP_CFG.pretrain = clone_cfg(SDF_CFG)
EXP_CFG.pretrain.enabled = True

EXP_CFG.pretrain.optimizer.learning_rate = 2e-4

EXP_CFG.pretrain.loss.sdf_relative_loss = True
EXP_CFG.pretrain.loss.sdf_relative_eps = 0.005
EXP_CFG.pretrain.batch.batch_size = 256
...
EXP_CFG.rl.launch.run_name = "sdf_only_rellos_128_newerreward"

EXP_CFG.rl.reward.object_goal_tracking_term_weight = 2
EXP_CFG.rl.reward.object_goal_tracking_fine_term_weight = 4
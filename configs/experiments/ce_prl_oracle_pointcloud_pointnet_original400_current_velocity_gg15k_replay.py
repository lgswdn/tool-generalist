"""Replay the original oracle GG run with old 400 grippers and current dynamics."""
...
EXP_CFG = generated_gripper_oracle_pointcloud_pointnet_rl_cfg(
    "ce_prl_oracle_pointcloud_pointnet_original400_current_velocity_gg15k_replay",

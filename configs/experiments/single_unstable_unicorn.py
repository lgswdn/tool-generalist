"""Single-arm unstable-pose RL over the full selected-tool set using UniCORN."""
...
EXP_CFG.name = "single_unstable_unicorn"
EXP_CFG.general.name = "single_unstable_unicorn"
...
EXP_CFG.rl.name = "single_unstable_unicorn"
EXP_CFG.rl.actor_critic_class = "ActorCriticTGUnicorn"
EXP_CFG.rl.launch.run_name = "single_unstable_unicorn"

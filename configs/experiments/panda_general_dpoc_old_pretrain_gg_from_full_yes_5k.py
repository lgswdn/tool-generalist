"""Old-pretrain DPOC GG fine-tuning initialized by its own full-YES 5k run."""
...
PARENT_EXPERIMENT = "panda_general_dpoc_old_pretrain_full_yes_5k"


EXP_CFG = generated_gripper_diff_post_rl_cfg(
    "panda_general_dpoc_old_pretrain_gg_from_full_yes_5k"
)

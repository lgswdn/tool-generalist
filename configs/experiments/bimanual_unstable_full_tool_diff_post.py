"""Bimanual RL using the full-tool diff+postcontact pretrained encoder."""
...
EXP_CFG.name = "bimanual_unstable_full_tool_diff_post"
EXP_CFG.general.name = "bimanual_unstable_full_tool_diff_post"

"""Full-YES RL with rank-6 PCA on UniCORN-ours pre-contact-MLP tokens."""
...
EXP_CFG = generated_gripper_unicorn_rl_cfg(
    "panda_general_unicorn_ours_encoder_pca_rank6_full_yes_5k",
    ours_tce=True,
)
...
EXP_CFG.model.tce.encoder_token_pca_rank = 6
